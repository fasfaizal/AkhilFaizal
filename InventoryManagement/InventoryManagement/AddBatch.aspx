<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddBatch.aspx.cs" Inherits="InventoryManagement.AddBatch" %>
        ...
        <div>
            <table>
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="ItemID" runat="server" ReadOnly="true"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>Name
